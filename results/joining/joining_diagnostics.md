...
- generated_at: 2026-03-16T10:25:41
...
- n_rows: `497931`
- doublons exacts: `0` (0.0%)
- doublons (user_id, parent_asin): `0` (0.0%)
...
### active_post_split_union
- rating: min=`1.0`, max=`5.0`, mean=`4.247`, median=`5.0`, hors intervalle=`0` (0.0%), ok=`True`
- timestamp: dtype=`int64`, min=`1996-12-17 04:37:25`, max=`2023-09-03 20:10:49.845000029`, non convertibles=`0`, ok=`False`
  - ⚠ 456 timestamps avant 2000
...
### temporal_post_split_union
- rating: min=`1.0`, max=`5.0`, mean=`4.4439`, median=`5.0`, hors intervalle=`0` (0.0%), ok=`True`
- timestamp: dtype=`datetime64[ms]`, min=`2020-01-01 00:17:29.935000`, max=`2023-09-03 20:10:49.845000`, non convertibles=`0`, ok=`True`
...
### active_post_split_union
- title: avg_len=`39.6`, median_len=`36`, vides=`0` (0.0%), HTML=`0` (0.0%)
- subtitle: avg_len=`21.8`, median_len=`24`, vides=`42583` (8.552%), HTML=`0` (0.0%)
- description: avg_len=`8690.0`, median_len=`3524`, vides=`59302` (11.9097%), HTML=`3177` (0.638%)
- categories: avg_len=`50.6`, median_len=`49`, vides=`607` (0.1219%), HTML=`0` (0.0%)
- features: avg_len=`1274.7`, median_len=`1146`, vides=`2148` (0.4314%), HTML=`282` (0.0566%)
- author_name: avg_len=`12.7`, median_len=`13`, vides=`21240` (4.2657%), HTML=`0` (0.0%)
- details_publisher: avg_len=`38.2`, median_len=`39`, vides=`0` (0.0%), HTML=`10` (0.002%)
- details_language: avg_len=`6.9`, median_len=`7`, vides=`0` (0.0%), HTML=`0` (0.0%)
...
### temporal_post_split_union
- title: avg_len=`46.2`, median_len=`39`, vides=`0` (0.0%), HTML=`0` (0.0%)
- subtitle: avg_len=`18.7`, median_len=`14`, vides=`29655` (10.3863%), HTML=`0` (0.0%)
- description: avg_len=`3827.1`, median_len=`1350`, vides=`95099` (33.3072%), HTML=`437` (0.1531%)
- categories: avg_len=`50.4`, median_len=`49`, vides=`1084` (0.3797%), HTML=`0` (0.0%)
- features: avg_len=`1362.4`, median_len=`1245`, vides=`4052` (1.4192%), HTML=`175` (0.0613%)
- author_name: avg_len=`12.3`, median_len=`12`, vides=`16807` (5.8864%), HTML=`0` (0.0%)
- details_publisher: avg_len=`31.8`, median_len=`34`, vides=`0` (0.0%), HTML=`1` (0.0004%)
- details_language: avg_len=`6.9`, median_len=`7`, vides=`0` (0.0%), HTML=`0` (0.0%)
...
### active_post_split_union
- path: `data/joining/active_post_split_union_clean_joined.parquet`
- rows: `497931`
- cols: `15`
...
### temporal_post_split_union
- path: `data/joining/temporal_post_split_union_clean_joined.parquet`
- rows: `285521`
- cols: `15`
